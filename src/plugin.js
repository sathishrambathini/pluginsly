...
class Plugins {
    ...
    downloadPlugins(apiKey) {
        ...
        console.log("_500Client.rest.serverUrl",_500Client.rest.serverUrl);

        // Call 500apps utility data method to get developer configured plugins
        return _500Client.rest.data(url, {}, this.filterPlugins, this.restFailure)
    }
