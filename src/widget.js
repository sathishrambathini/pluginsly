...
export default class Widgets {
    ...
    */
    pluginAuthorization(widgetData) {
        ...
        // Open child window
        window.open(`${window._Plugins.serverUrl}/Oauth54671?pluginId=${widgetData.pluginId}&apiKey=${widgetData.apiKey}&name=${widgetData.pluginName}`, "pluginsOauth", "width=650, height=650");
    }
